...
namespace E_Commerce_App.Models.Services
{
    public class JWTTokenService
    {
            ...
            private SignInManager<UserInterface> signInManager;
            public JWTTokenService(IConfiguration config, SignInManager<UserInterface> manager)
            {
            ...
            public async Task<string> GetToken(UserInterface user, TimeSpan expiresIn)
            {
